...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, TG(_MODS), KC_LALT, KC_LGUI, LT(_LOWER, KC_LBRC),   KC_SPC,   LT(_RAISE, KC_RBRC), KC_RALT, KC_PSCR, KC_RCTL, KC_BSLS
  ),

  [_MODS] = LAYOUT_planck_mit(
    LT(_NUM, KC_TAB), _______,      _______,      _______,      _______,             _______, _______, _______,             _______,      _______,      _______,      _______,
    LCTL_T(KC_ESC),   LSFT_T(KC_A), LALT_T(KC_S), LGUI_T(KC_D), _______,             _______, _______, _______,             LGUI_T(KC_K), LALT_T(KC_L), TD(SCLN_CLN), LCTL_T(KC_ENT),
    TD(LSFT_CAPS),    _______,      _______,      _______,      _______,             _______, _______, _______,             _______,      _______,      _______,      TD(RSFT_QUOTE),
    _______,          _______,      _______,      _______,      LT(_LOWER, KC_LBRC),      _______,     LT(_RAISE, KC_RBRC), _______,      _______,      _______,      _______
  ),
  ...
  [_NUM] = LAYOUT_planck_mit(
    _______, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, _______, _______, KC_7, KC_8,    KC_9,    KC_PAST, KC_PSLS,
